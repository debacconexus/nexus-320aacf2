...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Victim Services & Support Coordination";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Case Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "case_record_records";
'use strict';
